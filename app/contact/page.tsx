...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Tru Glow Clinic in Manikonda and HITEC City, Hyderabad. Book consultations for hair transplant, skin treatments, and cosmetic surgery. Reach us at +91 7799127273.",
